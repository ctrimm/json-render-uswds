...
${previewRef.current.innerHTML}
  ...
  return (
    <div className="h-screen flex flex-col bg-background overflow-hidden">
      ...
      {/* AI features banner */}
      <div className="bg-blue-50 border-b border-blue-200 px-4 py-2 text-center shrink-0">
        <p className="text-xs text-blue-700">
          Want to generate pages with AI?{" "}
          <a
            href="https://github.com/ctrimm/json-render-uswds"
            target="_blank"
            rel="noopener noreferrer"
            className="font-semibold underline underline-offset-2 hover:text-blue-900 transition"
          >
            Clone the repo locally
          </a>{" "}
          and add your own API key to unlock AI page generation.
        </p>
      </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-sidebar-foreground/50 hidden sm:block leading-none mt-0.5">
                USWDS component library for json-render
              </p>
            </div>
          </div>
          <a
                ...
                {!spec && (
                  <div className="flex items-center justify-center h-full">
                    <div className="text-center space-y-3 max-w-sm px-4">
                      ...
                      <div>
                        <p className="text-sm font-medium text-foreground">No fixture loaded</p>
                        <p className="text-xs text-muted-foreground mt-1">Select a fixture from the sidebar to preview a USWDS page.</p>
                      </div>
                      {!sidebarOpen && (
